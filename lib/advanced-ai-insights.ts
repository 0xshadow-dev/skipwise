...
export function generateAdvancedAIInsights(temptations: Temptation[], categoryStats: CategoryStats[]): AIInsight[] {
  ...
  if (currentStreak >= 5) {
    insights.push({
      ...
      type: 'behavioral',
      category: 'success',
      title: `🔥 ${currentStreak} Temptation Resistance Streak!`,
      description: `You're on fire! You've resisted ${currentStreak} consecutive temptations. This momentum is valuable.`,
